    ...
    return (
        <div>
            <footer className="px-4 divide-y dark:bg-gray-800 dark:text-gray-100">
                    ...
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            <div className="avatar">
                                <div className="w-12">
                                    <img src="https://img.freepik.com/free-vector/creative-project-management-concept-flat-style_23-2147792531.jpg?w=740&t=st=1703093078~exp=1703093678~hmac=c7e39163839241961e7c30d687158c1ea395de4e8d32ba5f2d43e8b80cab5c43" alt="Image" />
                                </div>
                            </div>
                            <span className="self-center text-2xl font-semibold">Task Management</span>
                        </a>
                    </div>
                ...
                <div className="py-6 text-sm text-center dark:text-gray-400">&copy; {year} Job Management Co. All rights reserved.</div>
            </footer>
        </div>
    );
};
